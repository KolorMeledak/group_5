...
class linkedList:
    ...
    def insertFront(self, data):
        ...
        print(f"Current Head: {self.head.value}, Head Next: {"None" if self.head.next == None else self.head.next.value}, Current Tail: {"None" if self.tail == None else self.tail.value}")
